...
This API project was created for our Bangkit capstone project, PsychIT.
...
## License
**PsychIT API**, utilizing the Express Starter framework, is licensed under the **MIT License**.
